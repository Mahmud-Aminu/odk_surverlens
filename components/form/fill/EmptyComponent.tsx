...
export const EmptyFormsState: React.FC<EmptyFormsStateProps> = ({
  ...
  return (
    <View
      className="flex-1 min-h-screen-safe items-center justify-center py-20 px-6"
    ...
    >
      ...
      />
      <AppText
        className="mt-4 text-gray-600 text-center font-medium"
        style={{ fontSize: 16 }}
      >
      ...
      */}
      ...
      >
        There are currently no blank forms available. Please refresh or download
      ...
      */}
      <TouchableOpacity
        ...
        className={`mt-6 px-6 py-3 rounded-md ${
          isRefreshing ? "bg-gray-400" : "bg-blue-500 active:bg-blue-600"
        }`}
      ...
      */}
      <TouchableOpacity
        ...
        accessibilityLabel="Go to download form"
        onPress={() => router.push("/(tabs)/forms/get")}
      >
