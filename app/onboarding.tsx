...
const FOCAL_PERSON_KEY = "@surveilPro_focal_person";
...
const OnboardingScreen = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            await AsyncStorage.setItem(FOCAL_PERSON_KEY, JSON.stringify(focalPersonData));
            setShowSuccess(true);
            setTimeout(() => {
                router.replace("/(tabs)");
            }, 2500);
        } catch (error) {
            console.error("Failed to save focal person data:", error);
