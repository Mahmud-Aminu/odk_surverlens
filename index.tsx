...
const ODKFormApp = () => {
  ...
  const [availableForms, setAvailableForms] = useState([
    ...
    },
    {
      ...
      downloaded: false,
      fields: [
        { id: 'respondent', label: 'Respondent Name', type: 'text', required: true },
        { id: 'date', label: 'Survey Date', type: 'date', required: true },
        { id: 'satisfaction', label: 'Satisfaction Level', type: 'select', options: ['Very Satisfied', 'Satisfied', 'Neutral', 'Dissatisfied', 'Very Dissatisfied'], required: true },
    ...
    },
    {
      ...
      fields: [
        ...
        { id: 'status', label: 'Status', type: 'select', options: ['Pass', 'Fail', 'Needs Review'], required: true },
        { id: 'notes', label: 'Inspection Notes', type: 'textarea', required: false },
        { id: 'follow_up', label: 'Follow-up Required', type: 'checkbox', required: false }
      ]
    }
  ]);
  ...
  const saveSubmission = (status) => {
    const submission = {
      ...
      data: formData,
      status: status,
      createdAt: editingSubmission ? editingSubmission.createdAt : new Date().toISOString(),
    ...
    <ScrollView style={styles.container}>
      ...
      {submissions.length === 0 ? (
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>No submissions yet. Fill out a form to get started.</Text>
        </View>
      ) : (
            ...
            <View style={styles.cardContent}>
              <View style={styles.cardLeft}>
                ...
                <View style={styles.statusContainer}>
                  ...
                  <Text style={[
                    styles.statusValue,
                    submission.status === 'finalized' ? styles.statusFinalized : styles.statusDraft
                  ]}>
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.tabBar}>
        ...
        >
          <Text style={[styles.tabText, view === 'forms' && styles.tabTextActive]}>
            Forms
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={[styles.tabText, view === 'submissions' && styles.tabTextActive]}>
